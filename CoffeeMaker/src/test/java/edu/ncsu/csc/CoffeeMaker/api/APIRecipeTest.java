...
public class APIRecipeTest {
    ...
    public void testDeleteRecipe () throws Exception {
        ...
        final Recipe r1 = createRecipe( name, 1, 1, 1, 1, 1 );
    ...
    public void testEditRecipe () throws Exception {
        ...
        final Recipe r1new = createRecipe( "Hot Chocolate", 75, 0, 2, 1, 2 );

        mvc.perform( put( "/api/v1/recipes/Coffee" ).contentType( MediaType.APPLICATION_JSON )
                .content( TestUtils.asJsonString( r1new ) ) ).andExpect( status().isOk() );
